...
> {
    ...
    body: OptionsRequest<Source>
    options: OptionsRequest<Source>
...
export interface OptionsRequest<Source extends OptionsSource = OptionsSource> extends StringIndexed {
    ...
    name: Source extends "interactive_message" | "dialog_suggestion" ? string
        : never
    callback_id: Source extends "interactive_message" | "dialog_suggestion" ? string
        : never
    action_ts: Source extends "interactive_message" | "dialog_suggestion" ? string
        : never

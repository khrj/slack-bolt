 ...
 * middleware.
 */
type ViewAckFn<VA extends SlackViewAction = SlackViewAction> = VA extends ViewSubmitAction ? AckFn<ViewResponseAction> // ViewClosedActions can only be acknowledged, there are no arguments
    : AckFn<void>

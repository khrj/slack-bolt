...
export type WorkflowStepEditMiddleware = Middleware<
    WorkflowStepEditMiddlewareArgs
>
export type WorkflowStepSaveMiddleware = Middleware<
    WorkflowStepSaveMiddlewareArgs
>
export type WorkflowStepExecuteMiddleware = Middleware<
    WorkflowStepExecuteMiddlewareArgs
>
...
export class WorkflowStep {
    ...
    private getStepMiddleware(
        payload: AllWorkflowStepMiddlewareArgs["payload"],
...
): args is AllWorkflowStepMiddlewareArgs {
...
function createStepConfigure(
    args: AllWorkflowStepMiddlewareArgs<WorkflowStepEditMiddlewareArgs>,
): StepConfigureFn {
    const {
        context,
        client,
...
function createStepUpdate(
    args: AllWorkflowStepMiddlewareArgs<WorkflowStepSaveMiddlewareArgs>,
): StepUpdateFn {
    const {
        context,
        client,
...
function createStepComplete(
    args: AllWorkflowStepMiddlewareArgs<WorkflowStepExecuteMiddlewareArgs>,
): StepCompleteFn {
    const {
        context,
        client,
